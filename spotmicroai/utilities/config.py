...
class Config(metaclass=Singleton):
    ...
    MOTION_CONTROLLER_SERVOS_ARM_ROTATION_MIN_ANGLE = 'motion_controller[*].servos[*].arm_rotation[*].min_angle | [0] | [0] | [0]'
    MOTION_CONTROLLER_SERVOS_ARM_ROTATION_MAX_ANGLE = 'motion_controller[*].servos[*].arm_rotation[*].max_angle | [0] | [0] | [0]'
    ...
    MOTION_CONTROLLER_SERVOS_ARM_LIFT_MIN_ANGLE = 'motion_controller[*].servos[*].arm_lift[*].min_angle | [0] | [0] | [0]'
    MOTION_CONTROLLER_SERVOS_ARM_LIFT_MAX_ANGLE = 'motion_controller[*].servos[*].arm_lift[*].max_angle | [0] | [0] | [0]'
    ...
    MOTION_CONTROLLER_SERVOS_ARM_RANGE_MIN_ANGLE = 'motion_controller[*].servos[*].arm_range[*].min_angle | [0] | [0] | [0]'
    MOTION_CONTROLLER_SERVOS_ARM_RANGE_MAX_ANGLE = 'motion_controller[*].servos[*].arm_range[*].max_angle | [0] | [0] | [0]'
    ...
    MOTION_CONTROLLER_SERVOS_ARM_CAM_TILT_MIN_ANGLE = 'motion_controller[*].servos[*].arm_cam_tilt[*].min_angle | [0] | [0] | [0]'
    MOTION_CONTROLLER_SERVOS_ARM_CAM_TILT_MAX_ANGLE = 'motion_controller[*].servos[*].arm_cam_tilt[*].max_angle | [0] | [0] | [0]'
    ...
    def get_by_section_name(self, search_pattern):
        ...
        return jmespath.search(PCA9685_ADDRESS, self.values), jmespath.search(PCA9685_REFERENCE_CLOCK_SPEED, self.values), jmespath.search(PCA9685_FREQUENCY, self.values), jmespath.search(CHANNEL, self.values), jmespath.search(MIN_PULSE, self.values), jmespath.search(MAX_PULSE, self.values), jmespath.search(REST_ANGLE, self.values), jmespath.search(MIN_ANGLE, self.values), jmespath.search(MAX_ANGLE, self.values)
